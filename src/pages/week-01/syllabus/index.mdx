...
<DeepDiveTabs title="Grade Breakdown" tabs={[
  { 
    id: 'weights', 
    label: '⚖️ Weights', 
    content: "<h3>⚖️ The Weighted Rubric</h3><table class='simple-rows'><tr><td><strong>Homework (Auto-Checks) - (GRADED)</strong></td><td style='text-align: right;'>20%</td></tr><tr><td><strong>Labs (Applied Skills) - (GRADED)</strong></td><td style='text-align: right;'>30%</td></tr><tr><td><strong>Checkpoint Quizzes - (GRADED)</strong></td><td style='text-align: right;'>20%</td></tr><tr><td><strong>Final Capstone Project</strong></td><td style='text-align: right;'>20%</td></tr><tr><td><strong>Participation (Activity)</strong></td><td style='text-align: right;'>10%</td></tr></table><p style='margin-top: 15px;'><em>Note: Every single item is graded out of 100 points, then averaged within its category.</em></p>" 
  }, 
  { 
    id: 'participation', 
