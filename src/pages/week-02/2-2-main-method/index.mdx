...
<div class="signature-breakdown">
  <div class="signature-part">
    ...
    <div class="part-explanation">
      ...
      <p class="analogy">🏭 <em>Analogy: A factory's emergency switch—you don't need to build a product first to hit it.</em></p>
    </div>
  </div>
  ...
  <div class="signature-part">
    ...
    <div class="part-explanation">
      ...
      <p class="note">📝 <em>Alternative: You can use <code>int</code> to return an exit code (0 = success, non-zero = error).</em></p>
    </div>
  </div>
  ...
  <div class="signature-part">
    ...
    <div class="part-explanation">
      ...
      <p class="warning">⚠️ <em>This is case-sensitive. <code>main()</code> will NOT be recognized.</em></p>
    </div>
  </div>
  ...
  <div class="signature-part">
    ...
    <div class="part-explanation">
      ...
      <p class="example">💻 <em>Example: <code>myapp.exe --verbose --file data.txt</code> passes ["--verbose", "--file", "data.txt"]</em></p>
    </div>
  </div>
</div>
