...
// Load course content summary (generated by build-course-context.mjs)
let COURSE_CONTENT_SUMMARY = '';
try {
  const summaryPath = path.join(__dirname, '_lib/course-summary.txt');
  if (fs.existsSync(summaryPath)) {
    COURSE_CONTENT_SUMMARY = fs.readFileSync(summaryPath, 'utf-8');
  }
} catch (e) {
