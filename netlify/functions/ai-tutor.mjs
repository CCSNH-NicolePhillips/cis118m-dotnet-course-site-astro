...
// Import course content summary (generated by build-course-context.mjs)
let COURSE_CONTENT_SUMMARY = '';
try {
  const courseSummaryModule = await import('./_lib/course-summary.mjs');
  COURSE_CONTENT_SUMMARY = courseSummaryModule.COURSE_CONTENT_SUMMARY || '';
} catch (e) {
  console.warn('[ai-tutor] Could not load course summary:', e.message);
}
