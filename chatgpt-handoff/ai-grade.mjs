/**
 * AI Grading API - Homework Reflection Grader
 * 
 * Uses Gemini 2.0 Flash for automated grading with rubric-based scoring.
 * Provides personalized feedback to students while storing detailed rubric for instructors.
 * 
 * TOKEN LIMIT: 250 output tokens max
...
export async function handler(event, context) {
  ...
  const model = genAI.getGenerativeModel({ 
    ...
    generationConfig: {
      ...
      maxOutputTokens: 250,  // Keep response concise
    }
  });
